...
class Profile
{
	...
	{
		return isset($this->profile->primaryclanid)
			? $this->profile->primaryclanid
			: -1;
	}
	...
	{
		return isset($this->profile->timecreated)
			? date($format, $this->profile->timecreated)
			: '';
	}
	...
	{
		return isset($this->profile->gameserverip)
			? $this->profile->gameserverip
			: '';
	}
	...
	{
		return isset($this->profile->gameextrainfo)
			? $this->profile->gameextrainfo
			: '';
	}
	...
	{
		return isset($this->profile->loccountrycode)
	...
	{
		return isset($this->profile->personaname)
	...
	{
		return isset($this->profile->profileurl)
	...
	{
		return isset($this->profile->avatarmedium)
	...
	{
		return isset($this->profile->avatarfull)
	...
	{
		return isset($this->profile->lastlogoff)
			? date($format, $this->profile->lastlogoff)
			: '';
	}
